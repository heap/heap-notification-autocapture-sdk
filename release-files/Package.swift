...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/heap/heap-swift-core-sdk.git", from: "0.9.0-alpha.10"),
    ],
    targets: [
        .target(
        ...
        .binaryTarget(
            ...
            checksum: "e83117d31b0d3e825732cbed4e186a45ab1033ab0a79de069528574c4da9b64f"
    )
    ],
